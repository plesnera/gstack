...
(Claude, Codex, Factory, Kiro, OpenCode, Slate, Cursor, OpenClaw, Vibe) is defined
...
export const ALL_HOST_CONFIGS: HostConfig[] = [
  claude, codex, factory, kiro, opencode, slate, cursor, openclaw, vibe, myhost
];

// Add to re-exports:
export { claude, codex, factory, kiro, opencode, slate, cursor, openclaw, vibe, myhost };
```
